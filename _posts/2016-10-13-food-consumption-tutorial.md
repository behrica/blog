...
The European Food Safety Authority collects food consumption data from all EU countries and and integrates them in their database. The data is based on country specific surveys, in which individuals get interviewed about their food consumption habits. This data is used for EFSAs risk assessments as part of the exposure assessment.
...
{% highlight text %}
## Error in zip("europe_jam_shp.zip", dir(".", "europe_jam.*")): 'files' must a character vector specifying one or more filepaths
{% endhighlight %}
...
![plot of chunk unnamed-chunk-16](/knitr-jekyll/figure/source/food-consumption-tutorial/2016-10-13-food-consumption-tutorial/unnamed-chunk-16-1.png)
...
## [1] sparklyr_0.2.27    ggplot2_2.1.0.9001 knitr_1.14        
## [4] tidyr_0.6.0        tmap_1.4-1         dplyr_0.5.0       
## [7] readxl_0.1.1      
## 
## loaded via a namespace (and not attached):
##  [1] Rcpp_0.12.7        sparkapi_0.3.14    lattice_0.20-34   
##  [4] deldir_0.1-12      class_7.3-14       gtools_3.5.0      
##  [7] assertthat_0.1     digest_0.6.10      R6_2.2.0          
## [10] plyr_1.8.4         evaluate_0.9       coda_0.18-1       
## [13] e1071_1.6-7        highr_0.6          lazyeval_0.2.0    
## [16] spdep_0.6-5        gdata_2.17.0       geosphere_1.5-5   
## [19] raster_2.5-8       gmodels_2.16.2     Matrix_1.2-7.1    
## [22] config_0.1.0       labeling_0.3       splines_3.3.1     
## [25] rgdal_1.1-10       servr_0.4          readr_1.0.0       
## [28] stringr_1.1.0      htmlwidgets_0.7    RCurl_1.95-4.8    
## [31] munsell_0.4.3      httpuv_1.3.3       rgeos_0.3-19      
## [34] htmltools_0.3.5    tibble_1.2         codetools_0.2-14  
## [37] XML_3.98-1.4       withr_1.0.2        MASS_7.3-45       
## [40] bitops_1.0-6       rappdirs_0.3.1     grid_3.3.1        
## [43] nlme_3.1-128       gtable_0.2.0       DBI_0.5-1         
## [46] magrittr_1.5       formatR_1.4        scales_0.4.0.9003 
## [49] KernSmooth_2.23-15 stringi_1.1.2      LearnBayes_2.15   
## [52] leaflet_1.0.1      sp_1.2-3           boot_1.3-17       
## [55] osmar_1.1-7        RColorBrewer_1.1-2 tools_3.3.1       
## [58] parallel_3.3.1     yaml_2.1.13        colorspace_1.2-6  
## [61] classInt_0.1-23    methods_3.3.1
{% endhighlight %}
